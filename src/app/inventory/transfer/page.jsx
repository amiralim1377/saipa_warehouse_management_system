  ...
  return (
    <div className="p-6 max-w-2xl mx-auto" dir="rtl">
      ...
      <form className="space-y-4">
        ...
        {/* انبار مبدا */}
        <div>
          <Label htmlFor="source">انبار مبدا</Label>
          <Select>
            <SelectTrigger id="source" className="w-full">
              <SelectValue placeholder="انتخاب انبار مبدا" />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="warehouse1">انبار ۱</SelectItem>
              <SelectItem value="warehouse2">انبار ۲</SelectItem>
            </SelectContent>
          </Select>
        </div>
        ...
        {/* انبار مقصد */}
        <div>
          <Label htmlFor="destination">انبار مقصد</Label>
          <Select>
        ...
        {/* تاریخ */}
        <div>
          <Label htmlFor="date">تاریخ انتقال</Label>
